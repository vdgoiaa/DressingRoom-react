...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case "SET_PRODUCT":
      ...
      // state.selectedProduct={topclothes: "123.png"}
      // TH1: type = 'topclothes'
      // state.selectedProduct={topclothes: "123.png",topclothes: "345.png"}
      // state.selectedProduct={topclothes: "345.png"}
      // TH2: type = 'botclothes'
      // state.selectedProduct={topclothes: "123.png",botclothes: "34565.png"}
...
// 1.component productItem , nhấn nút thử => dispatch action SET_PRODUCT
// 2.reducer , xây dựng cách xử lý action
// 3.component model , connect lên store, lấy selectedProduct xuống
